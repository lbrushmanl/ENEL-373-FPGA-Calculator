...
REM
REM Generated by Vivado on Thu Mar 10 12:18:04 +1300 2022
...
echo "xvhdl --incr --relax -prj Seg_Display_vhdl.prj"
call xvhdl  --incr --relax -prj Seg_Display_vhdl.prj -log xvhdl.log
