...
REM
REM Generated by Vivado on Sun Mar 20 18:51:50 +1300 2022
...
echo "xvhdl --incr --relax -prj displayTest_vhdl.prj"
call xvhdl  --incr --relax -prj displayTest_vhdl.prj -log xvhdl.log
